...
<head>
    ...
    <link href="{{ asset('admin_assets/assets/css/app-modern.min.css') }}" rel="stylesheet" id="light-style" />
    <link href="{{ asset('admin_assets/assets/css/app-modern-dark.min.css') }}" rel="stylesheet" id="dark-style" />
...
<body class="loading" data-layout="detached"
        ...
        <div class="container-fluid">
            ...
            <a href="index.html" class="topnav-logo">
                <span class="topnav-logo-lg">
                    <img src="{{ asset('admin_assets/assets/images/logo-light.png') }}" alt="" height="16">
                </span>
            ...
            <ul class="list-unstyled topbar-right-menu float-right mb-0">
                ...
                <li class="dropdown notification-list topbar-dropdown d-none d-lg-block">
                    <a class="nav-link dropdown-toggle arrow-none" data-toggle="dropdown" id="topbar-languagedrop"
                        ...
                        <img src="{{ asset('admin_assets/assets/images/flags/us.jpg') }} " alt="user-image"
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated topbar-dropdown-menu"
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <img src="{{ asset('admin_assets/assets/images/flags/germany.jpg') }} " alt="user-image"
                                class="mr-1" height="12">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-lg p-0">
                        ...
                        <div class="p-2">
                            <div class="row no-gutters">
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="{{ asset('admin_assets/assets/images/brands/slack.png') }}"
                                            alt="slack">
                                        <span>Slack</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="{{ asset('admin_assets/assets/images/brands/github.png') }}"
                                            alt="Github">
                                        <span>GitHub</span>
                                    </a>
                                </div>
                            ...
                            <div class="row no-gutters">
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="{{ asset('admin_assets/assets/images/brands/bitbucket.png') }}"
                                            alt="bitbucket">
                                        <span>Bitbucket</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="{{ asset('admin_assets/assets/images/brands/dropbox.png') }}"
                                            alt="dropbox">
                                        <span>Dropbox</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="{{ asset('admin_assets/assets/images/brands/g-suite.png') }}"
                                            alt="G Suite">
                                        <span>G Suite</span>
                                    </a>
                                </div>
                ...
                <li class="dropdown notification-list">
                    <a class="nav-link dropdown-toggle nav-user arrow-none mr-0" data-toggle="dropdown"
                        ...
                        <span class="account-user-avatar">
                            <img src="{{ asset('admin_assets/assets/images/users/avatar-1.jpg') }} " alt="user-image"
    ...
    <!-- third party js -->
    <script src="{{ asset('admin_assets/assets/js/vendor/apexcharts.min.js') }}"></script>
    <script src="{{ asset('admin_assets/assets/js/vendor/jquery-jvectormap-1.2.2.min.js') }}"></script>
    <script src="{{ asset('admin_assets/assets/js/vendor/jquery-jvectormap-world-mill-en.js') }}"></script>
    <!-- third party js ends -->
